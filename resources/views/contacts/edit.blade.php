                    ...
                    <div class="row">
                        ...
                        <form action="{{route('contacts.update',['id'=> $contact->id])}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nickname" id="nickname" value="{{$contact->nickname}}">
                            </div>
                            ...
                            <div id="addres" class="shadow-sm p-2 mt-2">
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-12 col-lg-3">
                                        ...
                                        <input type="text" id="cep" name="CEP" class="form-control m-input" value="{{$contact->CEP}}" autocomplete="off">
                                    </div>

                                    <div class="form-group mb-3 col-12 col-lg-6">
                                        <label for="labelName">Cidade</label>
                                        <input type="text" id="city" name="city" class="form-control m-input" value="{{$contact->city}}" autocomplete="off">
                                    </div>

                                    <div class="form-group mb-3 col-12 col-lg-3">
                                        <label for="labelName">Estado</label>
                                        <input type="text" id="state" name="state" class="form-control m-input" value="{{$contact->state}}" autocomplete="off">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group mb-3 col-12 col-lg-5">
                                        <label for="labelName">Endereço</label>
                                        <input type="text" id="address" name="address" class="form-control m-input" value="{{$contact->address}}" autocomplete="off">
                                    </div>

                                    <div class="form-group mb-3 col-12 col-lg-3">
                                        <label for="labelName">Numero</label>
                                        <input type="text" id="number" name="number" class="form-control m-input" value="{{$contact->number}}" autocomplete="off">
                                    </div>

                                    <div class="form-group mb-3 col-12 col-lg-4">
                                        <label for="labelName">Bairro</label>
                                        <input type="text" id="district" name="district" class="form-control m-input" value="{{$contact->district}}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="emailInputList" class="shadow-sm p-2 mt-2">
                                ...
                                @for ($i = 0; $i < count($contact->email);$i++)
                                    <div id="inputRowEmail" class="input-group mb-3">
                                        <input type="email" name="email[]" class="form-control m-input" required placeholder="nome@email.com" autocomplete="off" value="{{$contact->email[$i]->email}}">
                                        <div class="input-group-append">
                                            {!! $htmlExtensions->selectEmail('typeEmail','typeEmail[]', 'form-select', $contact->email[$i]->type_email_id) !!}
                                        </div>

                                        @if ($i >0 )
                                        <div class="input-group-append">
                                            <button id="removeEmail" type="button" class="btn btn-danger">Remover</button>
                                        </div>
                                        @endif
                                    </div>
                                    @endfor
                            ...
                            <div id="phoneInputList" class="shadow-sm p-2 mt-2">
                                ...
                                @for ($i = 0; $i < count($contact->phone);$i++)
                                    <div id="inputRowPhone" class="input-group mb-3">
                                        <input type="text" name="phone[]" class="form-control m-input phone" required minlength="14" placeholder="(01) 2345-6789" autocomplete="off" value="{{$contact->phone[$i]->phone}}">
                                        <div class="input-group-append">

                                            {!! $htmlExtensions->selectPhone('typePhone[]', 'typePhone[]','form-select', $contact->phone[$i]->type_phone_id) !!}
                                        </div>

                                        @if ($i >0 )
                                        <div class="input-group-append">
                                            <button id="removePhone" type="button" class="btn btn-danger">Remover</button>
                                        </div>
                                        @endif
                                    </div>
...
<script type="text/javascript">
    ...
    $("#addRow").click(function() {
        ...
        html += '<input type="email" name="email[]" class="form-control m-input" required placeholder="nome@email.com" autocomplete="off">';
    ...
    $("#addRowPhone").click(function() {
        ...
        html += '<input type="text" name="phone[]" class="form-control m-input" minlength="14" required placeholder="(01) 2345-6789" autocomplete="off">';
        html += '<div class="input-group-append">';
